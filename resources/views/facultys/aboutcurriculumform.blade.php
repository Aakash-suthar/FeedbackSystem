...
<div class="container-fluid" style="margin: 20px 10px 20px 10px;min-width:505px;">
    <div class="container-fluid" style="background-color: whitesmoke; box-shadow: 4px 5px 8px 2px rgba(0, 0, 0, 0.2), -3px -2px 8px 2px rgba(0, 0, 0, 0.2);border-radius: 10px;">
        <div class="content">
                {!! Form::open(['url' => '/Fcurriculum','method'=>'POST','autocomplete'=>'off']) !!}    
                <h3 align="center" style="margin-top: 20px;">About Curriculum Form </h3>
                 ...
                 <div style="margin:10px;margin-left:0px;" class="form-group col-xs-12">
                   ...
                   <div style="margin:10px;margin-left:0px;margin-bottom: 15px;" class="form-group col-xs-12">
                    ...
                    <div style="margin: 10px" class="form-group">
                            {{Form::label('', '2. The objectives of the syllabi are well defined:*',['class'=>'control-label col-xs-12'])}}                                                <label style="margin: 5px 0px 7px 20px"  class="radio-inline"><input type="radio" name="Q2" value="Strongly Agree" required>Strongly Agree</label>
